...
var ve = "style[".concat(v, "][").concat("data-styled-version", '="').concat("6.0.0-rc.2", '"]');
...
var Ee = function(e) {
  ...
  r2.setAttribute(v, "active"), r2.setAttribute("data-styled-version", "6.0.0-rc.2");
  var i2 = be();
...
function et(e, r2, o2) {
  var s2 = re(e), i2 = e, a2 = !$(e), u2 = r2.attrs, p = void 0 === u2 ? _ : u2, d = r2.componentId, h = void 0 === d ? function(e2, t) {
    ...
    Qe[n2] = (Qe[n2] || 0) + 1;
    var r3 = "".concat(n2, "-").concat(F("6.0.0-rc.2" + n2 + Qe[n2]));
...
var pt = function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      var t = e2.instance.toString(), n2 = be(), r2 = se([n2 && 'nonce="'.concat(n2, '"'), "".concat(v, '="true"'), "".concat("data-styled-version", '="').concat("6.0.0-rc.2", '"')].filter(Boolean), " ");
      ...
      if (e2.sealed)
        throw ue(2);
      var o2 = ((r2 = {})[v] = "", r2["data-styled-version"] = "6.0.0-rc.2", r2.dangerouslySetInnerHTML = { __html: e2.instance.toString() }, r2), s2 = be();
